...
const Register = () => {
    return (
       ...
       <div className="register-heading  col-lg-7 col-md-5">
         <h1>Register Now</h1>
          ...
          <div className="courses-form col-lg-5 col-md-2">
          <fieldset>
            <legend>Courses For Free</legend>
            <h5>It is high time for learning</h5>
           <form action="">
